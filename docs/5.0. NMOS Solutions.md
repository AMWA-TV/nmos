...
| ------- | ------- | ------------------------ | -------- |
| BFE | [KSC SILKNET](https://bfe.tv/en/solutions-products/control-monitoring-systems/ksc-silknet/) | IS-04 v1.3 <br/> IS-05 v1.1 <br/> IS-07 v1.0  | Broadcast SDN Controller |
