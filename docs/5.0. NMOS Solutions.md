...
| ------- | ------- | ------------------------ | -------- |
| BFE | [KSC CORE](https://www.bfe.tv/en/solutions-products/control-monitoring-systems/ksc-core/) <br/> [KSC SILKNET](https://bfe.tv/en/solutions-products/control-monitoring-systems/ksc-silknet/) | IS-04 v1.3 <br/> IS-05 v1.1 <br/> <br/> IS-07 v1.0  | Broadcast Controller, <br/> Broadcast SDN Controller |
